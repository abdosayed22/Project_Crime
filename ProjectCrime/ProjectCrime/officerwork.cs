      ...
      string offID;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < list.Count; i++)
            {
                ...
                string officerid = childerns[2].Name;
                ...
                if (myid ==offidval )
                {
                    ...
                    if (gradeviewAsscrime.ColumnCount == 0)
                    {
                        ...
                        gradeviewAsscrime.Columns.Add("Officer ID", officerid);
                        gradeviewAsscrime.Columns.Add("crimestat", value);

                    }

                    gradeviewAsscrime.Rows.Add(new string[] { idvalue, typevlaue, offidval,valuee });
